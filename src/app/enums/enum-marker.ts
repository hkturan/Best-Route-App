...
export class EnumMarker extends EnumType<EnumMarker>() {
  ...
  static readonly BLUE_MARKER = new EnumMarker(2, 'Destinations', 'blue-marker.png', '#246abf', '32px', '32px', true);
  ...
  static readonly BLUE_DIRECTION_MARKER = new EnumMarker(5, 'Direction', 'blue-direction-marker.png', '#246abf', '16px', '16px', false);
